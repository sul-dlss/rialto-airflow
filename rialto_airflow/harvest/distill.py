...
#
# Functions for determnining publication attributes.
#
...
def _apc_oa_dataset(pub, context):
...
class FuncRule:
    ...
    context: Optional[dict] = None # an optional dictionary of content for use in the matcher
